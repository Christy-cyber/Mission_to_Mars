...
# Setup HTML parser--convert the browser html to a soup object and then quit the browser
html = browser.html
...
# Use the parent element to find the first `a` tag and save it as `news_title`--paragraph text
